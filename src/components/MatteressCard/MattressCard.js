  ...
  return (
    <>
     <Link to="/jane">
       ...
       <div> <h4 className='hearticon'><BsSuitHeart className='suitheart'></BsSuitHeart></h4> </div>
        <img src={items.img}/>
        {/* <div className='launch'><h5 className='newlaunch'>Newly Launched</h5></div> */}
        ...
        <div className='matressContent'>
            <div className='matressleft-content'>
                ...
                <h4 className='price'>Rs.{items.price}   <del>Rs.33.678</del></h4>
            </div>
            <div className='matressright-content'>
                <h5  className='bold'>{items.rating}</h5>
                <p><div class="ms-auto text-warning"><MDBIcon fas icon="star" /></div></p>
                <p>(27)</p>
            </div>
        </div>
